...
public class SecuritySessionException extends Exception implements IBaseException {
  private BaseExceptionInfo exceptionInfo = null;

  public static String SESSION_ALREADY_EXISTS = "servlet_jsp_0300";
  public static String CANNOT_DESTROY_NOT_EXISTING_DOMAIN = "servlet_jsp_0301";

  public SecuritySessionException(String msg, Object [] parameters, Throwable linkedException) {
    super();
