...
import com.sap.engine.admin.model.itsam.jsr77.web.SAP_ITSAMJ2eeURLResource_Adapter;
 ...
 */
public class ITSAMURLResource extends SAP_ITSAMJ2eeURLResource_Adapter {
  ...
  public ITSAMURLResource(ObjectName objectName, String applicationName, String webModuleName, String resourceName) 
  																	throws InstanceAlreadyExistsException, MBeanRegistrationException, NotCompliantMBeanException {
  	//super: (String internalName, String caption)
	  internalName = JSR77ObjectNameFactory.getURLResourceName(resourceName);
