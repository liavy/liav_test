...
public class JspNullPointerException extends NullPointerException implements IBaseException {
  public static final String INTERNAL_SERVER_ERROR = "jsp_runtime_0013";
  public static final String ATTRIBUTE_NAME_NULL = "jsp_runtime_0016";

  private BaseExceptionInfo exceptionInfo = null;

  public JspNullPointerException(String msg) {
    super();
  ...
  public JspNullPointerException(String msg, Object [] parameters) {
    super();
    LocalizableTextFormatter formater = new LocalizableTextFormatter(WebResourceAccessor.getResourceAccessor(), msg, parameters);
    exceptionInfo = new BaseExceptionInfo(WebResourceAccessor.location, formater, this, null);
  }

  public JspNullPointerException(String msg, Throwable linkedException) {
    super();
    LocalizableTextFormatter formater = new LocalizableTextFormatter(WebResourceAccessor.getResourceAccessor(), msg);
    exceptionInfo = new BaseExceptionInfo(WebResourceAccessor.location, formater, this, linkedException);
  }

  public JspNullPointerException(String msg, Object [] parameters, Throwable linkedException) {
    super();
    LocalizableTextFormatter formater = new LocalizableTextFormatter(WebResourceAccessor.getResourceAccessor(), msg, parameters);
    exceptionInfo = new BaseExceptionInfo(WebResourceAccessor.location, formater, this, linkedException);
  }
  ...
  private Object writeReplace(){
    ...
    return new NullPointerException(stringWriter.toString());
  }
