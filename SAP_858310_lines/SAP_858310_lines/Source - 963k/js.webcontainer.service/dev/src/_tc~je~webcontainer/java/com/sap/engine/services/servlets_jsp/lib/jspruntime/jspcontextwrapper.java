...
public class JspContextWrapper extends PageContextImpl {
...
// Throwable in the generated servlet.
  ...
  public ELContext getELContext() {
    if (elContext == null) {
      PageContext pageCtx = invokingJspCtxt;
      while (pageCtx instanceof JspContextWrapper) {
        pageCtx = ((JspContextWrapper)pageCtx).invokingJspCtxt;
      }
      elContext = ((PageContextImpl)pageCtx).getJspApplicationContext().createELContext( invokingJspCtxt.getELContext().getELResolver(), this);
    }
    return elContext;
  }
}
