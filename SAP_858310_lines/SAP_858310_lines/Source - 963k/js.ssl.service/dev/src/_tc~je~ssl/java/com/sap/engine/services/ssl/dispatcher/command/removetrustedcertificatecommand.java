 ...
 * @version 4.3
 */
public class RemoveTrustedCertificateCommand implements Command {
  ...
  public void exec(Environment env, InputStream is, OutputStream os, String[] params) {
    ...
    try {
//      if (params.length == 1) {
//        runtime.removeTrustedCertificates(RuntimeInterfaceImpl.NEW_SERVER_SOCKETS, 0, params[0]);
//      } else if (params.length == 3) {
//        runtime.removeTrustedCertificates(params[0], Integer.parseInt(params[1]), params[2]);
//      } else {
//        out.println(getHelpMessage());
//      }
    } catch (Exception e) {
