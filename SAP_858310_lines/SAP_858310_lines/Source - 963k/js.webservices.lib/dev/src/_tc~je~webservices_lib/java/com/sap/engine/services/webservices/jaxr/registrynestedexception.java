 ...
 */
public class RegistryNestedException extends RegistryException {
  public RegistryNestedException(String msg, Throwable thr) {
    super(msg, thr);
  }
  
  public RegistryNestedException(Throwable thr) {
    super(thr);
  }
