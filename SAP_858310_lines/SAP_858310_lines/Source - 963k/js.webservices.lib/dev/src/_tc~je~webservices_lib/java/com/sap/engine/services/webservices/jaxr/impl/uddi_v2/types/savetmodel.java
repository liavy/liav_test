 ...
 * Represents schema complex type {urn:uddi-org:api_v2}save_tModel
 */

public  class SaveTModel extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[1].fieldJavaName = "TModel";
    FIELDINFO[1].fieldLocalName = "tModel";
    ...
    FIELDINFO[1].typeJavaName = "com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.TModel";
    FIELDINFO[1].typeLocalName = "tModel";
    FIELDINFO[1].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[1].getterMethod = "getTModel";
    FIELDINFO[1].setterMethod = "setTModel";
    FIELDINFO[1].checkMethod = "hasTModel";
    // Field 2
  ...
  // Element field
  private com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.TModel[] _f_TModel = new com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.TModel[0];
  public void setTModel(com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.TModel[] _TModel) {
    this._f_TModel = _TModel;
  }
  public com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.TModel[] getTModel() {
    return _f_TModel;
  }
