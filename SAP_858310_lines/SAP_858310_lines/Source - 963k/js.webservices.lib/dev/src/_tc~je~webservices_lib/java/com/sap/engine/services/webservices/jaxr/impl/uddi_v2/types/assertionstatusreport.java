 ...
 * Represents schema complex type {urn:uddi-org:api_v2}assertionStatusReport
 */

public  class AssertionStatusReport extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "AssertionStatusItem";
    FIELDINFO[0].fieldLocalName = "assertionStatusItem";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.AssertionStatusItem";
    FIELDINFO[0].typeLocalName = "assertionStatusItem";
    FIELDINFO[0].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[0].getterMethod = "getAssertionStatusItem";
    FIELDINFO[0].setterMethod = "setAssertionStatusItem";
    FIELDINFO[0].checkMethod = "hasAssertionStatusItem";
  }
  ...
  // Element field
  private com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.AssertionStatusItem[] _f_AssertionStatusItem = new com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.AssertionStatusItem[0];
  public void setAssertionStatusItem(com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.AssertionStatusItem[] _AssertionStatusItem) {
    this._f_AssertionStatusItem = _AssertionStatusItem;
  }
  public com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.AssertionStatusItem[] getAssertionStatusItem() {
    return _f_AssertionStatusItem;
  }
