...
public  class DependencyTypeSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Operator";
    FIELDINFO[0].fieldLocalName = "operator";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.relations.OperatorType";
    FIELDINFO[0].typeLocalName = "OperatorType";
    FIELDINFO[0].typeUri = "http://www.sap.com/webas/710/ws/property-relations";
    FIELDINFO[0].getterMethod = "getOperator";
    FIELDINFO[0].setterMethod = "setOperator";
