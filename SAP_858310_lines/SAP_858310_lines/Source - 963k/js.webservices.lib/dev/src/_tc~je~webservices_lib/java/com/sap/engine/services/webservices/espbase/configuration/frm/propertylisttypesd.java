 ...
 */
public  class PropertyListTypeSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initAttribs() {
    ...
    // Attribute 0
    ATTRIBUTEINFO[0].fieldLocalName = "selected";
    ATTRIBUTEINFO[0].fieldUri = "";
    ATTRIBUTEINFO[0].fieldJavaName = "Selected";
    ...
    ATTRIBUTEINFO[0].setterMethod = "setSelected";
    ATTRIBUTEINFO[0].getterMethod = "getSelected";
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.PropertyType[]";
