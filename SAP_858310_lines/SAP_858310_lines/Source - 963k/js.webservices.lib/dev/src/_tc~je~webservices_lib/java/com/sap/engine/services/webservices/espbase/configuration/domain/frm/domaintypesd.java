 ...
 */
public  class DomainTypeSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Domain";
    FIELDINFO[0].fieldLocalName = "domain";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.domain.DomainPropertyListType";
    FIELDINFO[0].typeLocalName = "DomainPropertyListType";
    FIELDINFO[0].typeUri = "http://www.sap.com/webas/710/ws/configuration-domain";
    FIELDINFO[0].getterMethod = "getDomain";
    FIELDINFO[0].setterMethod = "setDomain";
