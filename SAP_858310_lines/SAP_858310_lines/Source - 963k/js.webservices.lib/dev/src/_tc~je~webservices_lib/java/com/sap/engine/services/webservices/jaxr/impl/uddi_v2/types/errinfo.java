 ...
 * Represents schema complex type {urn:uddi-org:api_v2}errInfo
 */

public  class ErrInfo extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initAttribs() {
    ...
    // Attribute 0
    ATTRIBUTEINFO[0].fieldLocalName = "errCode";
    ATTRIBUTEINFO[0].fieldUri = "";
    ATTRIBUTEINFO[0].fieldJavaName = "ErrCode";
    ...
    ATTRIBUTEINFO[0].setterMethod = "setErrCode";
    ATTRIBUTEINFO[0].getterMethod = "getErrCode";
    ATTRIBUTEINFO[0].checkMethod = "hasErrCode";
  }
  ...
  // Attribute field
  private java.lang.String _a_ErrCode;
  private boolean _a_hasErrCode;
  // set method
  public void setErrCode(java.lang.String _ErrCode) {
    this._a_ErrCode = _ErrCode;
    this._a_hasErrCode = true;
  }
  // clear method
  public void clearErrCode(java.lang.String _ErrCode) {
    this._a_hasErrCode = false;
  }
  // get method
