 ...
 * Represents schema complex type {urn:uddi-org:api_v2}publisherAssertions
 */

public  class PublisherAssertions extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "PublisherAssertion";
    FIELDINFO[0].fieldLocalName = "publisherAssertion";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.PublisherAssertion";
    FIELDINFO[0].typeLocalName = "publisherAssertion";
    FIELDINFO[0].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[0].getterMethod = "getPublisherAssertion";
    FIELDINFO[0].setterMethod = "setPublisherAssertion";
    FIELDINFO[0].checkMethod = "hasPublisherAssertion";
  }
  ...
  // Element field
  private com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.PublisherAssertion[] _f_PublisherAssertion = new com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.PublisherAssertion[0];
  public void setPublisherAssertion(com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.PublisherAssertion[] _PublisherAssertion) {
    this._f_PublisherAssertion = _PublisherAssertion;
  }
  public com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.PublisherAssertion[] getPublisherAssertion() {
    return _f_PublisherAssertion;
  }
