 ...
 * Represents schema complex type {urn:uddi-org:api_v2}save_binding
 */

public  class SaveBinding extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[1].fieldJavaName = "BindingTemplate";
    FIELDINFO[1].fieldLocalName = "bindingTemplate";
    ...
    FIELDINFO[1].typeJavaName = "com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.BindingTemplate";
    FIELDINFO[1].typeLocalName = "bindingTemplate";
    FIELDINFO[1].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[1].getterMethod = "getBindingTemplate";
    FIELDINFO[1].setterMethod = "setBindingTemplate";
    FIELDINFO[1].checkMethod = "hasBindingTemplate";
  }
