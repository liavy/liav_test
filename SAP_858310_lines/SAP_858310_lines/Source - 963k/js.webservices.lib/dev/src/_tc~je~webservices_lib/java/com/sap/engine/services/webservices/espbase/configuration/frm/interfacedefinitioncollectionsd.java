 ...
 */
public  class InterfaceDefinitionCollectionSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  public java.lang.String _d_originalLocalName() {
    return "InterfaceDefinitionCollection";
  }
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "InterfaceDefinition";
    FIELDINFO[0].fieldLocalName = "InterfaceDefinition";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.InterfaceDefinition[]";
    FIELDINFO[0].typeLocalName = "InterfaceDefinition";
    FIELDINFO[0].typeUri = "http://www.sap.com/webas/710/ws/configuration-descriptor";
    FIELDINFO[0].getterMethod = "getInterfaceDefinition";
    FIELDINFO[0].setterMethod = "setInterfaceDefinition";
