 ...
 */
public  class DependencyListTypeSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Dependency";
    FIELDINFO[0].fieldLocalName = "dependency";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.soap_app.DependencyType[]";
    FIELDINFO[0].typeLocalName = "DependencyType";
    FIELDINFO[0].typeUri = "http://xml.sap.com/2006/11/esi/conf/soapapplication";
    FIELDINFO[0].getterMethod = "getDependency";
    FIELDINFO[0].setterMethod = "setDependency";
