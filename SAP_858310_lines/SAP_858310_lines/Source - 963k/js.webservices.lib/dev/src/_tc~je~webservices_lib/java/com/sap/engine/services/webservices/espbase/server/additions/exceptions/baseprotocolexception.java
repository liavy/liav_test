 ...
 * @version      6.30
 */
public class BaseProtocolException extends com.sap.engine.interfaces.webservices.runtime.ProtocolException implements IBaseException {
  
  private static final Location LOC = Location.getLocation(BaseProtocolException.class);
  
  private BaseExceptionInfo exceptionInfo;

  public BaseProtocolException(ResourceAccessor accessor, String pattern) {
    exceptionInfo = new BaseExceptionInfo(LOC, new LocalizableTextFormatter(accessor, pattern), this);
  }

  public BaseProtocolException(ResourceAccessor accessor, String pattern, Throwable cause) {
    exceptionInfo = new BaseExceptionInfo(LOC, new LocalizableTextFormatter(accessor, pattern), this, cause);
  }

  public BaseProtocolException(ResourceAccessor accessor, String pattern, Object[] obj) {
    exceptionInfo = new BaseExceptionInfo(LOC, new LocalizableTextFormatter(accessor, pattern, obj), this);
  }

  public BaseProtocolException(ResourceAccessor accessor, String pattern, Object[] obj, Throwable cause) {
    exceptionInfo = new BaseExceptionInfo(LOC, new LocalizableTextFormatter(accessor, pattern, obj), this, cause);
  }

  public BaseProtocolException(Throwable cause) {
