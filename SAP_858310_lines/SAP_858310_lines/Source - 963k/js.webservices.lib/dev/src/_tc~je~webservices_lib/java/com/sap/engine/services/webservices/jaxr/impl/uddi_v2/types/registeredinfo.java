 ...
 * Represents schema complex type {urn:uddi-org:api_v2}registeredInfo
 */

public  class RegisteredInfo extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "BusinessInfos";
    FIELDINFO[0].fieldLocalName = "businessInfos";
    ...
    FIELDINFO[0].typeLocalName = "businessInfos";
    FIELDINFO[0].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[0].getterMethod = "getBusinessInfos";
    FIELDINFO[0].setterMethod = "setBusinessInfos";
    FIELDINFO[0].checkMethod = "hasBusinessInfos";
    // Field 1
    FIELDINFO[1].defaultValue = null;
    FIELDINFO[1].fieldJavaName = "TModelInfos";
    FIELDINFO[1].fieldLocalName = "tModelInfos";
    ...
    FIELDINFO[1].typeJavaName = "com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.TModelInfo[]";
    FIELDINFO[1].typeLocalName = "tModelInfos";
    FIELDINFO[1].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[1].getterMethod = "getTModelInfos";
    FIELDINFO[1].setterMethod = "setTModelInfos";
    FIELDINFO[1].checkMethod = "hasTModelInfos";
  }
  ...
  // Element field
  private com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.BusinessInfo[] _f_BusinessInfos;

  public void setBusinessInfos(com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.BusinessInfo[] _BusinessInfos) {
    this._f_BusinessInfos = _BusinessInfos;
  }

  public com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.BusinessInfo[] getBusinessInfos() {
    return this._f_BusinessInfos;
  }
