 ...
 */
public  class RuleTypeSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[1].fieldJavaName = "CalculatedProperties";
    FIELDINFO[1].fieldLocalName = "calculated-properties";
    ...
    FIELDINFO[1].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.relations.PropertyListType";
    FIELDINFO[1].typeLocalName = "PropertyListType";
    FIELDINFO[1].typeUri = "http://www.sap.com/webas/710/ws/property-relations";
    FIELDINFO[1].getterMethod = "getCalculatedProperties";
    FIELDINFO[1].setterMethod = "setCalculatedProperties";
    FIELDINFO[1].checkMethod = null;
    // Field 2
    FIELDINFO[2].defaultValue = null;
    FIELDINFO[2].fieldJavaName = "ProfileProperties";
    FIELDINFO[2].fieldLocalName = "profile-properties";
    ...
    FIELDINFO[2].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.relations.PropertyWithoutValueListType";
    FIELDINFO[2].typeLocalName = "PropertyWithoutValueListType";
    FIELDINFO[2].typeUri = "http://www.sap.com/webas/710/ws/property-relations";
    FIELDINFO[2].getterMethod = "getProfileProperties";
    FIELDINFO[2].setterMethod = "setProfileProperties";
