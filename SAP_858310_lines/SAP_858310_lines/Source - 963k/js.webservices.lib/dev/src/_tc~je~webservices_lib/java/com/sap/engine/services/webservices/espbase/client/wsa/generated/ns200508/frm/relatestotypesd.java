 ...
 */
public  class RelatesToTypeSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initAttribs() {
    ...
    // Attribute 0
    ATTRIBUTEINFO[0].fieldLocalName = "RelationshipType";
    ATTRIBUTEINFO[0].fieldUri = "";
    ATTRIBUTEINFO[0].fieldJavaName = "RelationshipType";
    ATTRIBUTEINFO[0].typeName = "RelationshipTypeOpenEnum";
    ATTRIBUTEINFO[0].typeUri = "http://www.w3.org/2005/08/addressing";
    ATTRIBUTEINFO[0].typeJavaName = "java.lang.String";
    ATTRIBUTEINFO[0].defaultValue = "http://www.w3.org/2005/08/addressing/reply";
    ATTRIBUTEINFO[0].required = false;
    ATTRIBUTEINFO[0].setterMethod = "setRelationshipType";
    ATTRIBUTEINFO[0].getterMethod = "getRelationshipType";
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldUri = "http://www.w3.org/2005/08/addressing";
