 ...
 */
public  class PropertySetTypeSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Subject";
    FIELDINFO[0].fieldLocalName = "subject";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.p_set.SubjectType[]";
    FIELDINFO[0].typeLocalName = "subjectType";
    FIELDINFO[0].typeUri = "http://xml.sap.com/2006/11/esi/conf/feat/";
    FIELDINFO[0].getterMethod = "getSubject";
    FIELDINFO[0].setterMethod = "setSubject";
