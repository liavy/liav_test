 ...
 * Represents schema complex type {urn:uddi-org:api_v2}businessDetailExt
 */

public  class BusinessDetailExt extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "BusinessEntityExt";
    FIELDINFO[0].fieldLocalName = "businessEntityExt";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.BusinessEntityExt";
    FIELDINFO[0].typeLocalName = "businessEntityExt";
    FIELDINFO[0].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[0].getterMethod = "getBusinessEntityExt";
    FIELDINFO[0].setterMethod = "setBusinessEntityExt";
    FIELDINFO[0].checkMethod = "hasBusinessEntityExt";
  }
  ...
  // Element field
  private com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.BusinessEntityExt[] _f_BusinessEntityExt = new com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.BusinessEntityExt[0];
  public void setBusinessEntityExt(com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.BusinessEntityExt[] _BusinessEntityExt) {
    this._f_BusinessEntityExt = _BusinessEntityExt;
  }
  public com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.BusinessEntityExt[] getBusinessEntityExt() {
    return _f_BusinessEntityExt;
  }
