 ...
 * Represents schema complex type {urn:uddi-org:api_v2}dispositionReport
 */

public  class DispositionReport extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Result";
    FIELDINFO[0].fieldLocalName = "result";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.Result";
    FIELDINFO[0].typeLocalName = "result";
    FIELDINFO[0].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[0].getterMethod = "getResult";
    FIELDINFO[0].setterMethod = "setResult";
    FIELDINFO[0].checkMethod = "hasResult";
  }
  ...
  // Element field
  private com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.Result[] _f_Result = new com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.Result[0];
  public void setResult(com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.Result[] _Result) {
