 ...
 */
public  class ClassificationSystemMetaDataSD extends com.sap.engine.services.webservices.espbase.sr.metadata.frm.AbstractClassificationSystemMetaDataSD {
  ...
  public java.lang.String _d_originalLocalName() {
    return "ClassificationSystemMetaData";
  }
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "ClassificationValues";
    FIELDINFO[0].fieldLocalName = "ClassificationValues";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.espbase.sr.metadata.ClassificationValuesMetaData";
    FIELDINFO[0].typeLocalName = "ClassificationValuesMetaData";
    FIELDINFO[0].typeUri = "http://www.sap.com/webas/2006/11/sr/metadata";
    FIELDINFO[0].getterMethod = "getClassificationValues";
    FIELDINFO[0].setterMethod = "setClassificationValues";
