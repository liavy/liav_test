 ...
 */
public  class RelationTypeSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Dependencies";
    FIELDINFO[0].fieldLocalName = "dependencies";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.relations.DependencyDomainType";
    FIELDINFO[0].typeLocalName = "DependencyDomainType";
    FIELDINFO[0].typeUri = "http://www.sap.com/webas/710/ws/property-relations";
    FIELDINFO[0].getterMethod = "getDependencies";
    FIELDINFO[0].setterMethod = "setDependencies";
    FIELDINFO[0].checkMethod = null;
    // Field 1
    FIELDINFO[1].defaultValue = null;
    FIELDINFO[1].fieldJavaName = "Mappings";
    FIELDINFO[1].fieldLocalName = "mappings";
    ...
    FIELDINFO[1].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.relations.MappingsDomainType";
    FIELDINFO[1].typeLocalName = "MappingsDomainType";
    FIELDINFO[1].typeUri = "http://www.sap.com/webas/710/ws/property-relations";
    FIELDINFO[1].getterMethod = "getMappings";
    FIELDINFO[1].setterMethod = "setMappings";
