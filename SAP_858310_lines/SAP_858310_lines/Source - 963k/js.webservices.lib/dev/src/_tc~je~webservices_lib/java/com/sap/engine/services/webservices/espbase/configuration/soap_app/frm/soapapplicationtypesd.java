 ...
 */
public  class SoapApplicationTypeSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[1].fieldJavaName = "Properties";
    FIELDINFO[1].fieldLocalName = "properties";
    ...
    FIELDINFO[1].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.soap_app.PListType";
    FIELDINFO[1].typeLocalName = "PListType";
    FIELDINFO[1].typeUri = "http://xml.sap.com/2006/11/esi/conf/soapapplication";
    FIELDINFO[1].getterMethod = "getProperties";
    FIELDINFO[1].setterMethod = "setProperties";
    FIELDINFO[1].checkMethod = null;
    // Field 2
    FIELDINFO[2].defaultValue = null;
    FIELDINFO[2].fieldJavaName = "Dependencies";
    FIELDINFO[2].fieldLocalName = "dependencies";
    ...
    FIELDINFO[2].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.soap_app.DependencyListType";
    FIELDINFO[2].typeLocalName = "DependencyListType";
    FIELDINFO[2].typeUri = "http://xml.sap.com/2006/11/esi/conf/soapapplication";
    FIELDINFO[2].getterMethod = "getDependencies";
    FIELDINFO[2].setterMethod = "setDependencies";
