 ...
 */
public  class ClassificationValueSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Code";
    FIELDINFO[0].fieldLocalName = "code";
    ...
    FIELDINFO[0].getterMethod = "getCode";
    FIELDINFO[0].setterMethod = "setCode";
    ...
    // Field 2
    FIELDINFO[2].defaultValue = "true";
    FIELDINFO[2].fieldJavaName = "Selectable";
    FIELDINFO[2].fieldLocalName = "selectable";
    FIELDINFO[2].fieldModel = 1;
    FIELDINFO[2].fieldUri = "http://www.sap.com/webas/2006/11/sr/metadata";
    ...
    FIELDINFO[2].typeJavaName = "boolean";
    FIELDINFO[2].typeLocalName = "boolean";
    FIELDINFO[2].typeUri = "http://www.w3.org/2001/XMLSchema";
    FIELDINFO[2].getterMethod = "isSelectable";
    FIELDINFO[2].setterMethod = "setSelectable";
    FIELDINFO[2].checkMethod = null;
    // Field 3
    FIELDINFO[3].defaultValue = null;
    FIELDINFO[3].fieldJavaName = "Children";
    FIELDINFO[3].fieldLocalName = "children";
    FIELDINFO[3].fieldModel = 1;
    FIELDINFO[3].fieldUri = "http://www.sap.com/webas/2006/11/sr/metadata";
    ...
    FIELDINFO[3].typeJavaName = "com.sap.engine.services.webservices.espbase.sr.metadata.ClassificationValue[]";
    FIELDINFO[3].typeLocalName = "ClassificationValue";
    FIELDINFO[3].typeUri = "http://www.sap.com/webas/2006/11/sr/metadata";
    FIELDINFO[3].getterMethod = "getChildren";
    FIELDINFO[3].setterMethod = "setChildren";
