...
public class ServerRuntimeProcessException extends com.sap.engine.interfaces.webservices.runtime.RuntimeProcessException implements IBaseException {
  ...
  public ServerRuntimeProcessException(String pattern) {
    exceptionInfo = new BaseExceptionInfo(LOC, new LocalizableTextFormatter(RTResourceAccessor.getResourceAccessor(), pattern), this);
  }

  public ServerRuntimeProcessException(String pattern, Throwable cause) {
    exceptionInfo = new BaseExceptionInfo(LOC, new LocalizableTextFormatter(RTResourceAccessor.getResourceAccessor(), pattern), this, cause);
  }

  public ServerRuntimeProcessException(String pattern, Object[] obj) {
    exceptionInfo = new BaseExceptionInfo(LOC, new LocalizableTextFormatter(RTResourceAccessor.getResourceAccessor(), pattern, obj), this);
  }

  public ServerRuntimeProcessException(String pattern, Object[] obj, Throwable cause) {
    exceptionInfo = new BaseExceptionInfo(LOC, new LocalizableTextFormatter(RTResourceAccessor.getResourceAccessor(), pattern, obj), this, cause);
  }
