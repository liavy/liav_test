 ...
 * Represents schema complex type {urn:uddi-org:api_v2}tModelDetail
 */

public  class TModelDetail extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "TModel";
    FIELDINFO[0].fieldLocalName = "tModel";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.TModel";
    FIELDINFO[0].typeLocalName = "tModel";
    FIELDINFO[0].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[0].getterMethod = "getTModel";
    FIELDINFO[0].setterMethod = "setTModel";
    FIELDINFO[0].checkMethod = "hasTModel";
  }
