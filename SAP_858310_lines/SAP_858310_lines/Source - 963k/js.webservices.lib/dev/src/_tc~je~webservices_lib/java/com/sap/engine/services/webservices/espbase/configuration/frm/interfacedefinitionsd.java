 ...
 */
public  class InterfaceDefinitionSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initAttribs() {
    ...
    // Attribute 1
    ATTRIBUTEINFO[1].fieldLocalName = "interface-mapping-id";
    ATTRIBUTEINFO[1].fieldUri = "";
    ATTRIBUTEINFO[1].fieldJavaName = "InterfaceMappingId";
    ...
    ATTRIBUTEINFO[1].setterMethod = "setInterfaceMappingId";
    ATTRIBUTEINFO[1].getterMethod = "getInterfaceMappingId";
    ...
    ATTRIBUTEINFO[3].typeJavaName = "int";
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Variant";
    FIELDINFO[0].fieldLocalName = "Variant";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.Variant[]";
    FIELDINFO[0].typeLocalName = "Variant";
    FIELDINFO[0].typeUri = "http://www.sap.com/webas/710/ws/configuration-descriptor";
    FIELDINFO[0].getterMethod = "getVariant";
    FIELDINFO[0].setterMethod = "setVariant";
