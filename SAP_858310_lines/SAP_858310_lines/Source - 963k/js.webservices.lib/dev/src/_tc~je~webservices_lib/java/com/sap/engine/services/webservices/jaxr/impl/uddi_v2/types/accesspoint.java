 ...
 * Represents schema complex type {urn:uddi-org:api_v2}accessPoint
 */

public  class AccessPoint extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initAttribs() {
    ...
    // Attribute 0
    ATTRIBUTEINFO[0].fieldLocalName = "URLType";
    ATTRIBUTEINFO[0].fieldUri = "";
    ATTRIBUTEINFO[0].fieldJavaName = "URLType";
    ATTRIBUTEINFO[0].typeName = "URLType";
    ...
    ATTRIBUTEINFO[0].setterMethod = "setURLType";
    ATTRIBUTEINFO[0].getterMethod = "getURLType";
    ATTRIBUTEINFO[0].checkMethod = "hasURLType";
  }
  ...
  // Attribute field
  private java.lang.String _a_URLType;
  private boolean _a_hasURLType;
  // set method
  public void setURLType(java.lang.String _URLType) {
    this._a_URLType = _URLType;
    this._a_hasURLType = true;
  }
  // clear method
  public void clearURLType(java.lang.String _URLType) {
    this._a_hasURLType = false;
  }
  // get method
