 ...
 */
public class DeleteNestedException extends DeleteException {
  public DeleteNestedException(String msg, Throwable thr) {
    super(msg, thr);
  }
  
  public DeleteNestedException(Throwable thr) {
    super(thr);
  }
