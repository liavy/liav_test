 ...
 */
public  class RuleListTypeSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Rule";
    FIELDINFO[0].fieldLocalName = "rule";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.engine.services.webservices.espbase.configuration.relations.RuleType[]";
    FIELDINFO[0].typeLocalName = "RuleType";
    FIELDINFO[0].typeUri = "http://www.sap.com/webas/710/ws/property-relations";
    FIELDINFO[0].getterMethod = "getRule";
    FIELDINFO[0].setterMethod = "setRule";
