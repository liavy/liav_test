 ...
 * Represents schema complex type {urn:uddi-org:api_v2}delete_tModel
 */

public  class DeleteTModel extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[1].fieldJavaName = "TModelKey";
    FIELDINFO[1].fieldLocalName = "tModelKey";
    ...
    FIELDINFO[1].typeLocalName = "tModelKey";
    FIELDINFO[1].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[1].getterMethod = "getTModelKey";
    FIELDINFO[1].setterMethod = "setTModelKey";
    FIELDINFO[1].checkMethod = "hasTModelKey";
  }
