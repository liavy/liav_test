 ...
 * Represents schema complex type {urn:uddi-org:api_v2}serviceList
 */

public  class ServiceList extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "ServiceInfos";
    FIELDINFO[0].fieldLocalName = "serviceInfos";
    ...
    FIELDINFO[0].typeLocalName = "serviceInfos";
    FIELDINFO[0].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[0].getterMethod = "getServiceInfos";
    FIELDINFO[0].setterMethod = "setServiceInfos";
    FIELDINFO[0].checkMethod = "hasServiceInfos";
  }
