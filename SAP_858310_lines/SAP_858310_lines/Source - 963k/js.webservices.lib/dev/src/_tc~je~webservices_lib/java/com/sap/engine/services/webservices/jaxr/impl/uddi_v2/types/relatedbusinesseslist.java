 ...
 * Represents schema complex type {urn:uddi-org:api_v2}relatedBusinessesList
 */

public  class RelatedBusinessesList extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[1].fieldJavaName = "RelatedBusinessInfos";
    FIELDINFO[1].fieldLocalName = "relatedBusinessInfos";
    ...
    FIELDINFO[1].typeJavaName = "com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.RelatedBusinessInfo[]";
    FIELDINFO[1].typeLocalName = "relatedBusinessInfos";
    FIELDINFO[1].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[1].getterMethod = "getRelatedBusinessInfos";
    FIELDINFO[1].setterMethod = "setRelatedBusinessInfos";
    FIELDINFO[1].checkMethod = "hasRelatedBusinessInfos";
  }
  ...
  // Element field
  private com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.RelatedBusinessInfo[] _f_RelatedBusinessInfos;

  public void setRelatedBusinessInfos(com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.RelatedBusinessInfo[] _RelatedBusinessInfos) {
    this._f_RelatedBusinessInfos = _RelatedBusinessInfos;
  }

  public com.sap.engine.services.webservices.jaxr.impl.uddi_v2.types.RelatedBusinessInfo[] getRelatedBusinessInfos() {
    return this._f_RelatedBusinessInfos;
  }
