 ...
 * Represents schema complex type {urn:uddi-org:api_v2}delete_service
 */

public  class DeleteService extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[1].fieldJavaName = "ServiceKey";
    FIELDINFO[1].fieldLocalName = "serviceKey";
    ...
    FIELDINFO[1].typeLocalName = "serviceKey";
    FIELDINFO[1].typeUri = "urn:uddi-org:api_v2";
    FIELDINFO[1].getterMethod = "getServiceKey";
    FIELDINFO[1].setterMethod = "setServiceKey";
    FIELDINFO[1].checkMethod = "hasServiceKey";
  }
