 ...
 * All rights reserved.
 *
 * Thrown when the supplied configuration misses some element(s)
 * or the value(s) are not recorgnized. Also if incorrect parameters
 * are passed to the RuntimeTransportBinding methods.
 *
 * @author       Dimiter Angelov
 * @version      6.30
 */
public class ConfigurationException extends com.sap.engine.interfaces.webservices.runtime.TransportBindingException implements IBaseException {
  
  private static final Location LOC = Location.getLocation(ConfigurationException.class);
  
  private BaseExceptionInfo exceptionInfo;

  public ConfigurationException(ResourceAccessor accessor, String pattern) {
    exceptionInfo = new BaseExceptionInfo(LOC, new LocalizableTextFormatter(accessor, pattern), this);
  }

  public ConfigurationException(ResourceAccessor accessor, String pattern, Throwable cause) {
    exceptionInfo = new BaseExceptionInfo(LOC, new LocalizableTextFormatter(accessor, pattern), this, cause);
  }

  public ConfigurationException(ResourceAccessor accessor, String pattern, Object[] obj) {
    exceptionInfo = new BaseExceptionInfo(LOC, new LocalizableTextFormatter(accessor, pattern, obj), this);
  }

  public ConfigurationException(ResourceAccessor accessor, String pattern, Object[] obj, Throwable cause) {
