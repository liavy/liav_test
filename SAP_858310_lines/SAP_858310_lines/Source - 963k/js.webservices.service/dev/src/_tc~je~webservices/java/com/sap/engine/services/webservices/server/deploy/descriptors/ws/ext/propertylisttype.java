 ...
 * Represents type {http://www.sap.com/webas/710/ws/webservices-j2ee-engine-ext-descriptor}propertyListType
 */
public  class PropertyListType implements java.io.Serializable {

  private static final long serialVersionUID = 107200360225639751L;
   ...
   */
  public void setProperty(com.sap.engine.services.webservices.server.deploy.descriptors.ws.ext.PropertyType[] _Property) {
   ...
   */
  public com.sap.engine.services.webservices.server.deploy.descriptors.ws.ext.PropertyType[] getProperty() {
    com.sap.engine.services.webservices.server.deploy.descriptors.ws.ext.PropertyType[] result = new com.sap.engine.services.webservices.server.deploy.descriptors.ws.ext.PropertyType[_f_Property.size()];
  ...
  public boolean equals(Object object) {
    ...
    com.sap.engine.services.webservices.server.deploy.descriptors.ws.ext.PropertyType[] _f_Property1 = this.getProperty();
    com.sap.engine.services.webservices.server.deploy.descriptors.ws.ext.PropertyType[] _f_Property2 = typed.getProperty();
