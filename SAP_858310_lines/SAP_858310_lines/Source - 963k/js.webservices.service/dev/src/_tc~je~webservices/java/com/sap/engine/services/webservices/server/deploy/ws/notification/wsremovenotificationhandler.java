...
/**
 * Title: WSRemoveNotificationHandler
 * Description: WSRemoveNotificationHandler
 * 
 * @author Dimitrina Stoyanova
 * @version
 */

public class WSRemoveNotificationHandler extends WSAbstractDNotificationHandler {
 
  public WSRemoveNotificationHandler(String applicationName, RuntimeProcessingEnvironment runtimeProcessingEnvironment) {   
  ...
  protected void onCommitPhase(String applicationName, WebServicesDeploymentInterface componentForNotification) throws WSWarningException {
    componentForNotification.onRemove(applicationName);           
  }
