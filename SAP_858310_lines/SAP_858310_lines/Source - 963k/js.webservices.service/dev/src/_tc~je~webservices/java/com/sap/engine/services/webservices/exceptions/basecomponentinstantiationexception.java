...
public class BaseComponentInstantiationException extends ComponentInstantiationException implements IBaseException {

  private BaseExceptionInfo exceptionInfo = null;

  public BaseComponentInstantiationException() {
    this((LocalizableTextFormatter)null);
  }

  public BaseComponentInstantiationException(String s) {
    this(new LocalizableTextFormatter(ServerResourceAccessor.getResourceAccessor(), PatternKeys.DEFAULT_PATTERN, new Object[]{s}));
  }

  public BaseComponentInstantiationException(Throwable cause) {
    this(null, cause);
  }

  public BaseComponentInstantiationException(String patternKey, Object[] args) {
    this(new LocalizableTextFormatter(ServerResourceAccessor.getResourceAccessor(), patternKey, args));
  }

  public BaseComponentInstantiationException(String patternKey, Object[] args, Throwable t) {
    this(new LocalizableTextFormatter(ServerResourceAccessor.getResourceAccessor(), patternKey, args), t);
  }

  public BaseComponentInstantiationException(LocalizableTextFormatter locFormatter) {
    this(locFormatter, null, Severity.PATH, null);
  }

  public BaseComponentInstantiationException(LocalizableTextFormatter locFormatter, Category cat, int severity, Location loc) {
    this(locFormatter, cat, severity, loc, null);
  }

  public BaseComponentInstantiationException(LocalizableTextFormatter locFormatter, Throwable cause) {
    this(locFormatter, null, Severity.PATH, null, cause);
  }

  public BaseComponentInstantiationException(LocalizableTextFormatter locFormatter, Category cat, int severity, Location loc, Throwable cause) {
