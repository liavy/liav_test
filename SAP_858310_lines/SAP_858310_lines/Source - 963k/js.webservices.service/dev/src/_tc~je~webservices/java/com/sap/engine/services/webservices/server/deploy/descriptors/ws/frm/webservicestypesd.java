...
public  class WebservicesTypeSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "ConfigurationFile";
    FIELDINFO[0].fieldLocalName = "configuration-file";
    ...
    FIELDINFO[0].getterMethod = "getConfigurationFile";
    FIELDINFO[0].setterMethod = "setConfigurationFile";
    FIELDINFO[0].checkMethod = null;
    // Field 1
    FIELDINFO[1].defaultValue = null;
    FIELDINFO[1].fieldJavaName = "WsdlMappingFile";
    FIELDINFO[1].fieldLocalName = "wsdl-mapping-file";
    ...
    FIELDINFO[1].getterMethod = "getWsdlMappingFile";
    FIELDINFO[1].setterMethod = "setWsdlMappingFile";
    FIELDINFO[1].checkMethod = null;
    // Field 2
    FIELDINFO[2].defaultValue = null;
    FIELDINFO[2].fieldJavaName = "WebserviceDescription";
    FIELDINFO[2].fieldLocalName = "webservice-description";
    ...
    FIELDINFO[2].typeJavaName = "com.sap.engine.services.webservices.server.deploy.descriptors.ws.WebserviceDescriptionType[]";
    FIELDINFO[2].typeLocalName = "webservice-descriptionType";
    FIELDINFO[2].typeUri = "http://www.sap.com/webas/710/ws/webservices-j2ee-engine-descriptor";
    FIELDINFO[2].getterMethod = "getWebserviceDescription";
    FIELDINFO[2].setterMethod = "setWebserviceDescription";
    FIELDINFO[2].checkMethod = null;
    // Field 3
    FIELDINFO[3].defaultValue = null;
    FIELDINFO[3].fieldJavaName = "InterfaceDefinitionDescription";
    FIELDINFO[3].fieldLocalName = "interface-definition-description";
    ...
    FIELDINFO[3].typeJavaName = "com.sap.engine.services.webservices.server.deploy.descriptors.ws.InterfaceDefinitionDescriptionType[]";
    FIELDINFO[3].typeLocalName = "interface-definition-descriptionType";
    FIELDINFO[3].typeUri = "http://www.sap.com/webas/710/ws/webservices-j2ee-engine-descriptor";
    FIELDINFO[3].getterMethod = "getInterfaceDefinitionDescription";
    FIELDINFO[3].setterMethod = "setInterfaceDefinitionDescription";
