...
public class WSException extends WSBaseException implements IBaseException {

  public static String WS_BASE_EXCEPTION   = "webservices_5070";
  ...
  public WSException(String patternKey, Object[] args) {
    this(new LocalizableTextFormatter(ServerResourceAccessor.getResourceAccessor(), patternKey, args));
  }

  public WSException(String patternKey, Object[] args, Throwable t) {
    this(new LocalizableTextFormatter(ServerResourceAccessor.getResourceAccessor(), patternKey, args), t);
  }

  public WSException(LocalizableTextFormatter locFormatter) {
    this(locFormatter, null, Severity.PATH, null);
  }

  public WSException(LocalizableTextFormatter locFormatter, Category cat, int severity, Location loc) {
    this(locFormatter, cat, severity, loc, null);
  }

  public WSException(LocalizableTextFormatter locFormatter, Throwable cause) {
    this(locFormatter, null, Severity.PATH, null, cause);
  }

  public WSException(LocalizableTextFormatter locFormatter, Category cat, int severity, Location loc, Throwable cause) {
