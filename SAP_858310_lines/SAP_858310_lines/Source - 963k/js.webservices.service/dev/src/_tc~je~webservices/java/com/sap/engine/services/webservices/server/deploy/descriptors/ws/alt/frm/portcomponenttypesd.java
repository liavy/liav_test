...
public  class PortComponentTypeSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[1].fieldJavaName = "WsdlPort";
    FIELDINFO[1].fieldLocalName = "wsdl-port";
    ...
    FIELDINFO[1].typeJavaName = "com.sap.engine.services.webservices.server.deploy.descriptors.ws.alt.QNameType";
    FIELDINFO[1].typeLocalName = "qNameType";
    FIELDINFO[1].typeUri = "http://www.sap.com/webas/710/ws/webservices-j2ee-engine-alt-descriptor";
    FIELDINFO[1].getterMethod = "getWsdlPort";
    FIELDINFO[1].setterMethod = "setWsdlPort";
    FIELDINFO[1].checkMethod = null;
    // Field 2
    FIELDINFO[2].defaultValue = null;
    FIELDINFO[2].fieldJavaName = "Url";
    FIELDINFO[2].fieldLocalName = "url";
    ...
    FIELDINFO[2].getterMethod = "getUrl";
    FIELDINFO[2].setterMethod = "setUrl";
    FIELDINFO[2].checkMethod = null;
    // Field 3
    FIELDINFO[3].defaultValue = null;
    FIELDINFO[3].fieldJavaName = "ServiceEndpointInterface";
    FIELDINFO[3].fieldLocalName = "service-endpoint-interface";
    ...
    FIELDINFO[3].getterMethod = "getServiceEndpointInterface";
    FIELDINFO[3].setterMethod = "setServiceEndpointInterface";
    FIELDINFO[3].checkMethod = null;
    // Field 4
    FIELDINFO[4].defaultValue = null;
    FIELDINFO[4].fieldJavaName = "ImplementationLink";
    FIELDINFO[4].fieldLocalName = "implementation-link";
    ...
    FIELDINFO[4].typeJavaName = "com.sap.engine.services.webservices.server.deploy.descriptors.ws.alt.ImplementationLinkType";
    FIELDINFO[4].typeLocalName = "implementationLinkType";
    FIELDINFO[4].typeUri = "http://www.sap.com/webas/710/ws/webservices-j2ee-engine-alt-descriptor";
    FIELDINFO[4].getterMethod = "getImplementationLink";
    FIELDINFO[4].setterMethod = "setImplementationLink";
    FIELDINFO[4].checkMethod = null;
    // Field 5
    FIELDINFO[5].defaultValue = null;
    FIELDINFO[5].fieldJavaName = "MetaData";
    FIELDINFO[5].fieldLocalName = "meta-data";
    ...
    FIELDINFO[5].typeJavaName = "com.sap.engine.services.webservices.server.deploy.descriptors.ws.alt.MetaDataType";
    FIELDINFO[5].typeLocalName = "metaDataType";
    FIELDINFO[5].typeUri = "http://www.sap.com/webas/710/ws/webservices-j2ee-engine-alt-descriptor";
    FIELDINFO[5].getterMethod = "getMetaData";
    FIELDINFO[5].setterMethod = "setMetaData";
