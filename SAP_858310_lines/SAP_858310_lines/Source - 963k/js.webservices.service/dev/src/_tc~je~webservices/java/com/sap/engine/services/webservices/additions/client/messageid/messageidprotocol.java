 ...
 * @version 6.30
 * @deprecated Use com.sap.engine.services.webservices.jaxrpc.wsdl2java.features.builtin.MessageIdProtocol instead.
 */
public class MessageIdProtocol implements MessageIdFeature {
  
  private static final Location LOC = Location.getLocation(MessageIdProtocol.class);
    ...
    if (msg != null) { // This is soap binding
      ...
      if (feature.isDefined()) { // This feature is defined
        ...
        try {
          ...
          throw new ClientProtocolException("Unable to add message id header.", e);
        }
      }
    }
    return true;
  ...
  public ClientFeatureProvider newInstance() {
    try {
      ...
      throw new RuntimeException("Exception occurred while instantiating MessageIdProtocol", e);
    }
  }
