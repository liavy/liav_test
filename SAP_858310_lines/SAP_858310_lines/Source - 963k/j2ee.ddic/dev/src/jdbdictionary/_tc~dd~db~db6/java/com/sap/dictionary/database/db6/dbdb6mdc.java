...
public class DbDb6MDC
{
	...
	private ArrayList<String> mdcColumnList = new ArrayList<String>();
	...
	public ArrayList<String> getMdcColumnList()
	{
		return mdcColumnList;
	}

	public void setMdcColumnList(ArrayList<String> mdcColumnList)
	{
