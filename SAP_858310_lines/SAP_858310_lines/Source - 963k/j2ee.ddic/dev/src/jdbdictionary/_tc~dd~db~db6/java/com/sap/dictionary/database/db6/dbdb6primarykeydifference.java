...
public class DbDb6PrimaryKeyDifference extends DbPrimaryKeyDifference
{

  public DbDb6PrimaryKeyDifference( DbPrimaryKey origin,
                                    DbPrimaryKey target,
                                    Action action)
  {
  ...
  {
    //
    // currently DB6 supports no primary key specific attributes
