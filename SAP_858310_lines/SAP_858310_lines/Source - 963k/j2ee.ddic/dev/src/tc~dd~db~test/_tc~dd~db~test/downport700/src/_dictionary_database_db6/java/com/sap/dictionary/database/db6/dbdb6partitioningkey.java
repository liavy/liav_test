...
public class DbDb6PartitioningKey
{
	...
	private ArrayList partitioningKeyColumns = new ArrayList();
	...
	public void setPartitioningKey(ArrayList partitioningKeyColumns)
	{
		this.partitioningKeyColumns = partitioningKeyColumns;
	}

	public ArrayList getPartitioningKey()
	{
	...
	public boolean checkColumns(DbColumns cols)
	{
		...
		{
			colName = (String)partitioningKeyColumns.get(i);
	...
	public boolean checkColumns(ArrayList cols)
	{
