...
/**
 * <p>Java class for GetEnvironmentResponse element declaration.
 * 
...
public class GetEnvironmentResponse {
    ...
    protected JAXBElement<ArrayOfString> env;
     ...
     *     
     */
    public JAXBElement<ArrayOfString> getEnv() {
        return env;
    }
     ...
     *     
     */
    public void setEnv(JAXBElement<ArrayOfString> value) {
        this.env = ((JAXBElement<ArrayOfString> ) value);
    }
