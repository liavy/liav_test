...
/**
 *
 * Interface for administrating the context attribute extension for the TextContainer.
 *
 * <br/><br/>Copyright (c) 2006, SAP AG
 * @author  Thomas Goering
 * @version 1.0
 */
public interface TextContainerExtension
{

	/**
	 * Gets the context attribute extension.
	 *
	 * @return Context attribute extension.
	 */
