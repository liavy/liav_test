 ...
 */
public class LegalHoldAddCommand extends AbstractGetLegalHoldValuesCommandImpl
{
  private static final int MAX_ILM_CASE_LENGTH = 64;
  
  protected LegalHoldAddCommand(AbstractArchSession archSessionRef, String archuser)
  {
    super(archSessionRef, archuser, true);
    super.addParam("method", "LEGALHOLD");
    super.addParam("submethod", "ADD");
  }
  ...
  public void addParam(String headerField, boolean value) throws MethodNotApplicableException
  {
    ...
    {
      throw new MethodNotApplicableException("\"LEGALHOLDADD\" command does not support the boolean parameter \"" + headerField + "\"");
    }
  }
