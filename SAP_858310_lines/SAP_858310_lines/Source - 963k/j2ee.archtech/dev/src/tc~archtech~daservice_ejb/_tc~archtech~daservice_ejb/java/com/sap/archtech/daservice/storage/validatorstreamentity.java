...
public class ValidatorStreamEntity implements IRequestEntity {
	...
	public ValidatorStreamEntity(InputStream is, String contentType,
			Schema schema) {
		this.is = is;
	...
	public void write(IRequestStream destination) throws IOException {
		...
		try {
			...
			validator.validate(new SAXSource(new InputSource(iswrw)));
