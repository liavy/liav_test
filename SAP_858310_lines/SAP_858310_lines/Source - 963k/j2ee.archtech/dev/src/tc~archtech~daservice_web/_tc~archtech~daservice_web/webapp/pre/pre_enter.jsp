...
<html>
  ...
  <body bgcolor="white">
    ...
    <table border="1" width="100%" cellpadding="5" cellspacing="5">
      <tr>
        ...
        <td width="80%" bgcolor="#FFFFFF">
          <h1><b><font face="Arial" color="#003366" size="5">Pack Resources</font></b></h1>
        </td>
      </tr>
    </table>
    ...
    To pack resources, enter the necessary information:
    <p>
  
    <form action="pre_execute.jsp" method="post">
