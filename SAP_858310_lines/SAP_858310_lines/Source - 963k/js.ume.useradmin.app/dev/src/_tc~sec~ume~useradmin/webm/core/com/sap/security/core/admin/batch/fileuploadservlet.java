...
public class FileUploadServlet extends HttpServlet {
    public final static String  VERSIONSTRING = "$Id: //engine/js.ume.useradmin.app/dev/src/_tc~sec~ume~useradmin/webm/core/com/sap/security/core/admin/batch/FileUploadServlet.java#1 $ from $DateTime: 2008/09/17 17:08:55 $ ($Change: 217715 $)";
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) {
        try {
            ...
            FileUploadLogic logic = new FileUploadLogic(accessor);
