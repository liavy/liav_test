...
<table cellpadding="0" cellspacing="0" border="0" width="99%">
    <tr class="SEC_TB_TD"><td class="SEC_TB_TD">
      <span tabindex="0"><%=userAdminLocale.get("USER_ACTIVATION_HEADER")%></span>
    </td></tr>
</table>
<!-- End Section Header -->
...
<table align="center" cellpadding="0" cellspacing="0" width="99%" border="0">
  <tr><td width="100%" class="TBLO_XXS_L">
    <span tabindex="0"><%=userAdminLocale.get("USER_ACTIVATION_DESCRIPTION")%></span>
  </td></tr>
</table>
...
<table width="98%" border="0" cellpadding="0" cellspacing="0">
  <tr><td width="100%" class="TBLO_XS_L" nowrap>
    <input type="submit"
           name="<%=UserAdminLogic.performUserUnlockAction%>"
           tabindex="0" 
