...
<table cellpadding="0" cellspacing="0" border="0" width="99%" align="center">
  <tr class="SEC_TB_TD"><td class="SEC_TB_TD">
      <span tabindex="0"><%=userAdminLocale.get("PSWD_BULKEXPIRE_HEADER")%></span>
  </td></tr>
</table>
...
<table align="center" cellpadding="0" cellspacing="0" width="99%" border="0">
  <tr><td width="100%" class="TBLO_XXS_L">
    <span tabindex="0"><%=userAdminLocale.get("PSWD_BULKEXPIRE_DESCRIPTION")%></span>
  </td></tr>
</table>
  ...
  <tr><td CLASS="TBLO_XXS_L">
    ...
    <tr>
      <td CLASS="TBLO_XXS_R" tabindex="0" nowrap>
            <%=userAdminLocale.get("EXPIRED_BY")%>:
      </td>
    ...
    <tr>
      <td CLASS="TBLO_XXS_R" tabindex="0" nowrap>
            <%=userAdminLocale.get("EXPIRE_DATE")%>:
      </td>
...
<table width="98%" border="0" cellpadding="0" cellspacing="0">
  <tr><td width="100%" class="TBLO_XS_L" nowrap>
    ...
    <input class="BTN_LN"
           type="submit"
           tabindex="0" 
           name="<%=UserAdminLogic.cancelPswdExpireAction%>"
