...
<table cellpadding="0" cellspacing="0" border="0" width="99%" align="center">
      <tr class="SEC_TB_TD"><td class="SEC_TB_TD">
				&nbsp;<%=userAdminLocale.get("UPLOAD_TOOK")%> <%=((Long)proxy.getSessionAttribute("lastRunTime")).longValue()%> 				<%=userAdminLocale.get("SECONDS")%>&nbsp;&nbsp;&nbsp;<%=userAdminLocale.get("NUMBER_OF_GROUPS_PROCESSED")%>:&nbsp;<%=size%>
	  </td></tr>
</table>
...
<tr>
   ...
   <td class="TBDATA_XXS_L"  nowrap><center><b><%=userAdminLocale.get("NAME")%></b></center></td>
   <td class="TBDATA_XXS_L"  nowrap><center><b><%=userAdminLocale.get("DESCRIPTION")%></b></center></td>
   <td class="TBDATA_XXS_L"  nowrap><center><b><%=userAdminLocale.get("USERS")%></b></center></td>
   <td class="TBDATA_XXS_L"  nowrap><center><b><%=userAdminLocale.get("WARNINGS")%></b></center></td>
 </tr>
<%
...
%>
  ...
  <tr>
   ...
   %>
   <%=com.sap.security.core.util.taglib.EncodeHtmlTag.encode(gn)%>
   </center></td>
   ...
   %>
   <%=com.sap.security.core.util.taglib.EncodeHtmlTag.encode(gd)%>
   </center></td>
