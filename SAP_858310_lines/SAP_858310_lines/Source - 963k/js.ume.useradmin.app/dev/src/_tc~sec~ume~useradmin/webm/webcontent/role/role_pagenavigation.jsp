...
function paging(pageObj,command) 
{
    ...
    object.action = "<%=RoleAdminServlet.alias%>";
    object.submit();
}
...
function jump(value,command) 
{
    ...
    object.submit();
        ...
        <tr>
				...
				<a href="#" onClick="jump('<%=previous%>','role-assignment-page-navigation')"><img src="<%=webpath%>layout/left.gif" width="14" height="13" border="0" alt="<%=userAdminLocale.get("PREVIOUS_PAGE")%>" title="<%=userAdminLocale.get("PREVIOUS_PAGE")%>"></a>&nbsp;
				<% } %>
<%=userAdminLocale.get("TOTAL")%>:<%=totalItems%>&nbsp;<%=userAdminLocale.get("ITEMS")%> &nbsp;<%=userAdminLocale.get("DISPLAY")%>&nbsp;
				<select name="itemPerPage" size="1" class="DROPDOWN" onChange="javascript:changeNumber(this,'role-assignment-page-navigation')">
				...
				<select name="reqPage" size="1" class="DROPDOWN" onChange="javascript:paging(this,'role-assignment-page-navigation')">
                ...
                <a href="#" onClick="javascript:jump('<%=next%>','role-assignment-page-navigation')"><img src="<%=webpath%>layout/right.gif" width="14" height="13" border="0" alt="<%=userAdminLocale.get("NEXT_PAGE")%>" title="<%=userAdminLocale.get("NEXT_PAGE")%>"></a>&nbsp;&nbsp;&nbsp;
                <% } else {%>
