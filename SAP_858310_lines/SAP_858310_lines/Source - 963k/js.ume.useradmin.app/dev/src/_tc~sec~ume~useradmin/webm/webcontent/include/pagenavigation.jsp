...
<script language="JavaScript">
	function paging(pageObj) {
        ...
        inputTag1.setAttribute("name", "<%=UserAdminLogic.performSearchResultNavigateAction%>");
...
<tr>
	...
	<span tabindex="0"><%=userAdminLocale.get("TOTAL")%>:<%=totalItems%>&nbsp;<%=userAdminLocale.get("DISPLAY")%></span>&nbsp;
	<select id="itemPerPage" tabindex="0" name="itemPerPage" size="1" class="DROPDOWN" onChange="javascript:changeNumber(this)">
	...
	<select id="reqPage" tabindex="0" name="reqPage" size="1" class="DROPDOWN" onChange="javascript:paging(this)">
