...
public class SAPMLogonServlet extends HttpServlet {
  ...
  public final static String VERSIONSTRING = "$Id: //engine/js.ume.useradmin.app/dev/src/_tc~sec~ume~logon/webapp/WEB-INF/java/com/sap/security/core/sapmimp/logon/SAPMLogonServlet.java#1 $ from $DateTime: 2008/09/17 17:08:55 $ ($Change: 217715 $)";
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    try {
      IAccessToLogic accessor = 
          new ServletAccessToLogic(req, resp, IAccessToLogic.ENV_LOGONSERVLET);
      SAPMLogonLogic logic = new SAPMLogonLogic(accessor);
