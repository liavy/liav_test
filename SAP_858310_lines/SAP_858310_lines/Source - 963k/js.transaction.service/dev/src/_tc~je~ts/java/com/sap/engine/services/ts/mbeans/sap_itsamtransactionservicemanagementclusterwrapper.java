/*
 ...
 to wrap datatypes of attributes of CIMClass SAP_ITSAMTransactionServiceManagementCluster
...
public class SAP_ITSAMTransactionServiceManagementClusterWrapper implements
		DynamicMBean {

	/* The wrapped object to be exposed as MBean */
	private SAP_ITSAMTransactionServiceManagementCluster mbean;
	...
	static {
		...
		mbeanInfo = new MBeanInfo(
				...
				"SAP_ITSAMTransactionServiceManagementCluster MBean",
				attributeInfo, null, operationInfo, null);

	}

	/*
	 * Wraps given SAP_ITSAMTransactionServiceManagementCluster and provides a
	 * javax.management.DynamicMBean interface on top
	 */
	public SAP_ITSAMTransactionServiceManagementClusterWrapper(
			SAP_ITSAMTransactionServiceManagementCluster mbean) {
		this.mbean = mbean;
	}

	/*
	 * Creates an empty wrapper for SAP_ITSAMTransactionServiceManagementCluster
	 */
	public SAP_ITSAMTransactionServiceManagementClusterWrapper() {
	}

	/*
	 * Sets a new SAP_ITSAMTransactionServiceManagementCluster to be wrapped and
	 * returns the old one
	 */
	public SAP_ITSAMTransactionServiceManagementCluster setManagedObject(
			SAP_ITSAMTransactionServiceManagementCluster mbean) {
		SAP_ITSAMTransactionServiceManagementCluster old = this.mbean;
		this.mbean = mbean;
		return old;
	}
	 ...
	 * SAP_ITSAMTransactionServiceManagementCluster
	 */
	public SAP_ITSAMTransactionServiceManagementCluster getManagedObject() {
		return this.mbean;
	}
