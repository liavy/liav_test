...
public class BaseResourceException extends ResourceException implements IBaseException {

  static final long serialVersionUID = 1946186386823140100L;
  private BaseExceptionInfo info = null;

  public BaseResourceException(String key) {
    super(key);
  ...
  public BaseResourceException(String key, Object arg) {
    this(key, new Object[]{arg});
  }

  public BaseResourceException(String key, Object arg, Throwable t) {
    this(key, new Object[]{arg}, t);
  }

  public BaseResourceException(String key, Object[] args) {
    super(key);
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseResourceException(String key, Throwable t) {
    super(key);
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseResourceException(String key, Object[] args, Throwable t) {
    super(key);
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  */
  public void log() {
    ...
    private Object writeReplace(){
        ...
        return new ResourceException(stringWriter.toString());
    }
