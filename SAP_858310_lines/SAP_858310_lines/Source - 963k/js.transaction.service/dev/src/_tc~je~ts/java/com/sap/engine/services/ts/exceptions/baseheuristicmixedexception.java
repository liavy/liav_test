...
public class BaseHeuristicMixedException extends HeuristicMixedException implements IBaseException {

  static final long serialVersionUID = 8739293989746579084L;
  private BaseExceptionInfo info = null;

  public BaseHeuristicMixedException(String key) {
    super();
  ...
  public BaseHeuristicMixedException(String key, Object arg) {
    this(key, new Object[]{arg});
  }

  public BaseHeuristicMixedException(String key, Object arg, Throwable t) {
    this(key, new Object[]{arg}, t);
  }

  public BaseHeuristicMixedException(String key, Object[] args) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseHeuristicMixedException(String key, Throwable t) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseHeuristicMixedException(String key, Object[] args, Throwable t) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
 ...
 */
  public void log() {
    ...
    private Object writeReplace(){
        ...
        return new HeuristicMixedException(stringWriter.toString());
    }
