...
public class BaseRollbackException extends RollbackException implements IBaseException {

  static final long serialVersionUID = 1275448585203136604L;
  private BaseExceptionInfo info = null;

  public BaseRollbackException(String key) {
    super();
  ...
  public BaseRollbackException(String key, Object arg) {
    this(key, new Object[]{arg});
  }

  public BaseRollbackException(String key, Object arg, Throwable t) {
    this(key, new Object[]{arg}, t);
  }

  public BaseRollbackException(String key, Object[] args) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseRollbackException(String key, Throwable t) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseRollbackException(String key, Object[] args, Throwable t) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public void log() {
    ...
    private Object writeReplace(){
        ...
        return new RollbackException(stringWriter.toString());
    }
