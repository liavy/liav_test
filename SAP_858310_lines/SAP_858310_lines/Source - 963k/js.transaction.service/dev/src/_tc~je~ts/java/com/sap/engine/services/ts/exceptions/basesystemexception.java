...
public class BaseSystemException extends SystemException implements IBaseException {

  static final long serialVersionUID = -7605094486370202952L;
  private BaseExceptionInfo info = null;

  public BaseSystemException(String key) {
    super();
  ...
  public BaseSystemException(String key, Object arg) {
    this(key, new Object[]{arg});
  }

  public BaseSystemException(String key, Object arg, Throwable t) {
    this(key, new Object[]{arg}, t);
  }

  public BaseSystemException(String key, Object[] args) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseSystemException(String key, Throwable t) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseSystemException(String key, Object[] args, Throwable t) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public void log() {
    ...
    private Object writeReplace(){
        ...
        return new SystemException(stringWriter.toString());
    }
