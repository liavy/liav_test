...
public class BaseIllegalStateException extends IllegalStateException implements IBaseException {

  static final long serialVersionUID = 3384400325190940001L;
  private BaseExceptionInfo info = null;

  public BaseIllegalStateException(String key) {
    super();
  ...
  public BaseIllegalStateException(String key, Object arg) {
    this(key, new Object[]{arg});
  }

  public BaseIllegalStateException(String key, Object arg, Throwable t) {
    this(key, new Object[]{arg}, t);
  }

  public BaseIllegalStateException(String key, Object[] args) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseIllegalStateException(String key, Throwable t) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseIllegalStateException(String key, Object[] args, Throwable t) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
