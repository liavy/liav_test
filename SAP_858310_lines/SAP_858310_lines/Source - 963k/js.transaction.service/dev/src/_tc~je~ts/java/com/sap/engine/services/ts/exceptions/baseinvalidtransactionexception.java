...
public class BaseInvalidTransactionException extends InvalidTransactionException implements IBaseException {

  static final long serialVersionUID = -5882709118072623016L;
  private BaseExceptionInfo info = null;

  public BaseInvalidTransactionException(String key) {
    super();
  ...
  public BaseInvalidTransactionException(String key, Object arg) {
    this(key, new Object[]{arg});
  }

  public BaseInvalidTransactionException(String key, Object arg, Throwable t) {
    this(key, new Object[]{arg}, t);
  }

  public BaseInvalidTransactionException(String key, Object[] args) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseInvalidTransactionException(String key, Throwable t) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseInvalidTransactionException(String key, Object[] args, Throwable t) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
 ...
 */
  ...
  public void log() {
    ...
    private Object writeReplace(){
        ...
        return new InvalidTransactionException(stringWriter.toString());
    }
