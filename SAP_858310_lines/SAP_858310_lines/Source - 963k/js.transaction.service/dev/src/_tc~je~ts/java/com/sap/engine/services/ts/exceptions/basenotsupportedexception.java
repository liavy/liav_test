...
public class BaseNotSupportedException extends NotSupportedException implements IBaseException {

  static final long serialVersionUID = 2698924288064286008L;
  private BaseExceptionInfo info = null;

  public BaseNotSupportedException(String key) {
    super();
  ...
  public BaseNotSupportedException(String key, Object arg) {
    this(key, new Object[]{arg});
  }

  public BaseNotSupportedException(String key, Object arg, Throwable t) {
    this(key, new Object[]{arg}, t);
  }

  public BaseNotSupportedException(String key, Object[] args) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseNotSupportedException(String key, Throwable t) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  public BaseNotSupportedException(String key, Object[] args, Throwable t) {
    super();
    info = new BaseExceptionInfo(TSResourceAccessor.location,
  ...
  */
  public void log() {
    ...
    private Object writeReplace(){
        ...
        return new NotSupportedException(stringWriter.toString());
    }
