...
public class DeployTransaction extends DeployUpdateTransaction
{
	...
	// Logging:
//	private static final Location LOCATION = Location.getLocation("com.sap.engine.services.textcontainer.handler.transaction.DeployTransaction");
