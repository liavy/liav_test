 ...
 */
public  class J2EEGetThreadListResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Thread";
    FIELDINFO[0].fieldLocalName = "thread";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfJ2EEThread";
    FIELDINFO[0].typeLocalName = "ArrayOfJ2EEThread";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getThread";
    FIELDINFO[0].setterMethod = "setThread";
