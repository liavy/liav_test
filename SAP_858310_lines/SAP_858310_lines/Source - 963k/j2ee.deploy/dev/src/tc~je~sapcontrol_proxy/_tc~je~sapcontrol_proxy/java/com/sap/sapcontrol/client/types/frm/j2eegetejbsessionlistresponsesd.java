 ...
 */
public  class J2EEGetEJBSessionListResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Ejbsession";
    FIELDINFO[0].fieldLocalName = "ejbsession";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfJ2EEEJBSession";
    FIELDINFO[0].typeLocalName = "ArrayOfJ2EEEJBSession";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getEjbsession";
    FIELDINFO[0].setterMethod = "setEjbsession";
