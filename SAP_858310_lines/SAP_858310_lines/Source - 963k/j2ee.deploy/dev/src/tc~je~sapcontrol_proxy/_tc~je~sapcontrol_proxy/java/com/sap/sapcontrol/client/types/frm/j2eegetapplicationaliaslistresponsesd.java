 ...
 */
public  class J2EEGetApplicationAliasListResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Alias";
    FIELDINFO[0].fieldLocalName = "alias";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfJ2EEApplicationAlias";
    FIELDINFO[0].typeLocalName = "ArrayOfJ2EEApplicationAlias";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getAlias";
    FIELDINFO[0].setterMethod = "setAlias";
