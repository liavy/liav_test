 ...
 */
public  class J2EEGetCacheStatistic2ResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Cache";
    FIELDINFO[0].fieldLocalName = "cache";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfJ2EECache2";
    FIELDINFO[0].typeLocalName = "ArrayOfJ2EECache2";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getCache";
    FIELDINFO[0].setterMethod = "setCache";
