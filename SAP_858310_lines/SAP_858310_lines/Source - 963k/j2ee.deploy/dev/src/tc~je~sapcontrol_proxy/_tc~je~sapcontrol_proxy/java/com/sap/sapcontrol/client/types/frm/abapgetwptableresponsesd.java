 ...
 */
public  class ABAPGetWPTableResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Workprocess";
    FIELDINFO[0].fieldLocalName = "workprocess";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfWorkProcess";
    FIELDINFO[0].typeLocalName = "ArrayOfWorkProcess";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getWorkprocess";
    FIELDINFO[0].setterMethod = "setWorkprocess";
