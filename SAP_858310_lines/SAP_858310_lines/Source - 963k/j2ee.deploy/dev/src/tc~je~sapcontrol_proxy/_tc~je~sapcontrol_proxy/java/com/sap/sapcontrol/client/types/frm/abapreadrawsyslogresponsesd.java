 ...
 */
public  class ABAPReadRawSyslogResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Log";
    FIELDINFO[0].fieldLocalName = "log";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfRawSyslogEntry";
    FIELDINFO[0].typeLocalName = "ArrayOfRawSyslogEntry";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getLog";
    FIELDINFO[0].setterMethod = "setLog";
