 ...
 */
public  class GetQueueStatisticResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Queue";
    FIELDINFO[0].fieldLocalName = "queue";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfTaskHandlerQueue";
    FIELDINFO[0].typeLocalName = "ArrayOfTaskHandlerQueue";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getQueue";
    FIELDINFO[0].setterMethod = "setQueue";
