 ...
 */
public  class ABAPAcknowledgeAlertsResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Alert";
    FIELDINFO[0].fieldLocalName = "alert";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfInt";
    FIELDINFO[0].typeLocalName = "ArrayOfInt";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getAlert";
    FIELDINFO[0].setterMethod = "setAlert";
