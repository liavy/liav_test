 ...
 */
public  class OSExecuteResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Exitcode";
    FIELDINFO[0].fieldLocalName = "exitcode";
    ...
    FIELDINFO[0].getterMethod = "getExitcode";
    FIELDINFO[0].setterMethod = "setExitcode";
    FIELDINFO[0].checkMethod = null;
    // Field 1
    FIELDINFO[1].defaultValue = null;
    FIELDINFO[1].fieldJavaName = "Pid";
    FIELDINFO[1].fieldLocalName = "pid";
    ...
    FIELDINFO[1].getterMethod = "getPid";
    FIELDINFO[1].setterMethod = "setPid";
    FIELDINFO[1].checkMethod = null;
    // Field 2
    FIELDINFO[2].defaultValue = null;
    FIELDINFO[2].fieldJavaName = "Lines";
    FIELDINFO[2].fieldLocalName = "lines";
    ...
    FIELDINFO[2].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfString";
    FIELDINFO[2].typeLocalName = "ArrayOfString";
    FIELDINFO[2].typeUri = "urn:SAPControl";
    FIELDINFO[2].getterMethod = "getLines";
    FIELDINFO[2].setterMethod = "setLines";
