 ...
 */
public  class J2EEGetSharedTableInfoResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Jsf";
    FIELDINFO[0].fieldLocalName = "jsf";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfJ2EESharedTableInfo";
    FIELDINFO[0].typeLocalName = "ArrayOfJ2EESharedTableInfo";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getJsf";
    FIELDINFO[0].setterMethod = "setJsf";
