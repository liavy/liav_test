 ...
 */
public  class ReadLogFileResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Format";
    FIELDINFO[0].fieldLocalName = "format";
    ...
    FIELDINFO[0].getterMethod = "getFormat";
    FIELDINFO[0].setterMethod = "setFormat";
    FIELDINFO[0].checkMethod = null;
    // Field 1
    FIELDINFO[1].defaultValue = null;
    FIELDINFO[1].fieldJavaName = "Startcookie";
    FIELDINFO[1].fieldLocalName = "startcookie";
    ...
    FIELDINFO[1].getterMethod = "getStartcookie";
    FIELDINFO[1].setterMethod = "setStartcookie";
    FIELDINFO[1].checkMethod = null;
    // Field 2
    FIELDINFO[2].defaultValue = null;
    FIELDINFO[2].fieldJavaName = "Endcookie";
    FIELDINFO[2].fieldLocalName = "endcookie";
    ...
    FIELDINFO[2].getterMethod = "getEndcookie";
    FIELDINFO[2].setterMethod = "setEndcookie";
    FIELDINFO[2].checkMethod = null;
    // Field 3
    FIELDINFO[3].defaultValue = null;
    FIELDINFO[3].fieldJavaName = "Fields";
    FIELDINFO[3].fieldLocalName = "fields";
    ...
    FIELDINFO[3].getterMethod = "getFields";
    FIELDINFO[3].setterMethod = "setFields";
