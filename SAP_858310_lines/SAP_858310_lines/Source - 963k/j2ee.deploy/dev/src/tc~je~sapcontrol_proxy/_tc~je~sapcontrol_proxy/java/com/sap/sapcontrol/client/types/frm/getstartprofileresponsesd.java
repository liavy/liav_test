 ...
 * Represents type of namespace {urn:SAPControl} anonymous with xpath [/definitions/types/schema/element[12]/complexType]
 */
public  class GetStartProfileResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[1].fieldJavaName = "Lines";
    FIELDINFO[1].fieldLocalName = "lines";
    ...
    FIELDINFO[1].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfString";
    FIELDINFO[1].typeLocalName = "ArrayOfString";
    FIELDINFO[1].typeUri = "urn:SAPControl";
    FIELDINFO[1].getterMethod = "getLines";
    FIELDINFO[1].setterMethod = "setLines";
