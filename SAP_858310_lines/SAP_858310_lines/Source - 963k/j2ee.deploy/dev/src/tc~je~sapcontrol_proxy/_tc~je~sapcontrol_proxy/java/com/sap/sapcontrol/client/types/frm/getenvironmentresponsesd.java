 ...
 */
public  class GetEnvironmentResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Env";
    FIELDINFO[0].fieldLocalName = "env";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfString";
    FIELDINFO[0].typeLocalName = "ArrayOfString";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getEnv";
    FIELDINFO[0].setterMethod = "setEnv";
