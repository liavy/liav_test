 ...
 */
public  class J2EEGetRemoteObjectListResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Remoteobject";
    FIELDINFO[0].fieldLocalName = "remoteobject";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfJ2EERemoteObject";
    FIELDINFO[0].typeLocalName = "ArrayOfJ2EERemoteObject";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getRemoteobject";
    FIELDINFO[0].setterMethod = "setRemoteobject";
