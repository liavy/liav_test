 ...
 */
public  class WorkProcessSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "No";
    FIELDINFO[0].fieldLocalName = "No";
    ...
    FIELDINFO[0].getterMethod = "getNo";
    FIELDINFO[0].setterMethod = "setNo";
    ...
    FIELDINFO[3].fieldJavaName = "Status";
    FIELDINFO[3].fieldLocalName = "Status";
    ...
    FIELDINFO[3].getterMethod = "getStatus";
    FIELDINFO[3].setterMethod = "setStatus";
    FIELDINFO[3].checkMethod = null;
    // Field 4
    FIELDINFO[4].defaultValue = null;
    FIELDINFO[4].fieldJavaName = "Reason";
    FIELDINFO[4].fieldLocalName = "Reason";
    ...
    FIELDINFO[4].getterMethod = "getReason";
    FIELDINFO[4].setterMethod = "setReason";
    FIELDINFO[4].checkMethod = null;
    // Field 5
    FIELDINFO[5].defaultValue = null;
    FIELDINFO[5].fieldJavaName = "Start";
    FIELDINFO[5].fieldLocalName = "Start";
    ...
    FIELDINFO[5].getterMethod = "getStart";
    FIELDINFO[5].setterMethod = "setStart";
    FIELDINFO[5].checkMethod = null;
    // Field 6
    FIELDINFO[6].defaultValue = null;
    FIELDINFO[6].fieldJavaName = "Err";
    FIELDINFO[6].fieldLocalName = "Err";
    ...
    FIELDINFO[6].getterMethod = "getErr";
    FIELDINFO[6].setterMethod = "setErr";
    FIELDINFO[6].checkMethod = null;
    // Field 7
    FIELDINFO[7].defaultValue = null;
    FIELDINFO[7].fieldJavaName = "Sem";
    FIELDINFO[7].fieldLocalName = "Sem";
    ...
    FIELDINFO[7].getterMethod = "getSem";
    FIELDINFO[7].setterMethod = "setSem";
    FIELDINFO[7].checkMethod = null;
    // Field 8
    FIELDINFO[8].defaultValue = null;
    FIELDINFO[8].fieldJavaName = "Cpu";
    FIELDINFO[8].fieldLocalName = "Cpu";
    ...
    FIELDINFO[8].getterMethod = "getCpu";
    FIELDINFO[8].setterMethod = "setCpu";
    FIELDINFO[8].checkMethod = null;
    // Field 9
    FIELDINFO[9].defaultValue = null;
    FIELDINFO[9].fieldJavaName = "Time";
    FIELDINFO[9].fieldLocalName = "Time";
    ...
    FIELDINFO[9].getterMethod = "getTime";
    FIELDINFO[9].setterMethod = "setTime";
    FIELDINFO[9].checkMethod = null;
    // Field 10
    FIELDINFO[10].defaultValue = null;
    FIELDINFO[10].fieldJavaName = "Program";
    FIELDINFO[10].fieldLocalName = "Program";
    ...
    FIELDINFO[10].getterMethod = "getProgram";
    FIELDINFO[10].setterMethod = "setProgram";
    FIELDINFO[10].checkMethod = null;
    // Field 11
    FIELDINFO[11].defaultValue = null;
    FIELDINFO[11].fieldJavaName = "Client";
    FIELDINFO[11].fieldLocalName = "Client";
    ...
    FIELDINFO[11].getterMethod = "getClient";
    FIELDINFO[11].setterMethod = "setClient";
    FIELDINFO[11].checkMethod = null;
    // Field 12
    FIELDINFO[12].defaultValue = null;
    FIELDINFO[12].fieldJavaName = "User";
    FIELDINFO[12].fieldLocalName = "User";
    ...
    FIELDINFO[12].getterMethod = "getUser";
    FIELDINFO[12].setterMethod = "setUser";
    FIELDINFO[12].checkMethod = null;
    // Field 13
    FIELDINFO[13].defaultValue = null;
    FIELDINFO[13].fieldJavaName = "Action";
    FIELDINFO[13].fieldLocalName = "Action";
    ...
    FIELDINFO[13].getterMethod = "getAction";
    FIELDINFO[13].setterMethod = "setAction";
    FIELDINFO[13].checkMethod = null;
    // Field 14
    FIELDINFO[14].defaultValue = null;
    FIELDINFO[14].fieldJavaName = "Table";
    FIELDINFO[14].fieldLocalName = "Table";
    ...
    FIELDINFO[14].getterMethod = "getTable";
    FIELDINFO[14].setterMethod = "setTable";
