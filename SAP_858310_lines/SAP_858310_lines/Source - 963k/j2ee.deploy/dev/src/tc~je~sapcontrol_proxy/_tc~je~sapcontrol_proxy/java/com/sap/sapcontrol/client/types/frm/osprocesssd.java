 ...
 */
public  class OSProcessSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[2].fieldJavaName = "Dispstatus";
    FIELDINFO[2].fieldLocalName = "dispstatus";
    ...
    FIELDINFO[2].getterMethod = "getDispstatus";
    FIELDINFO[2].setterMethod = "setDispstatus";
    FIELDINFO[2].checkMethod = null;
    // Field 3
    FIELDINFO[3].defaultValue = null;
    FIELDINFO[3].fieldJavaName = "Textstatus";
    FIELDINFO[3].fieldLocalName = "textstatus";
    ...
    FIELDINFO[3].getterMethod = "getTextstatus";
    FIELDINFO[3].setterMethod = "setTextstatus";
    FIELDINFO[3].checkMethod = null;
    // Field 4
    FIELDINFO[4].defaultValue = null;
    FIELDINFO[4].fieldJavaName = "Starttime";
    FIELDINFO[4].fieldLocalName = "starttime";
    ...
    FIELDINFO[4].getterMethod = "getStarttime";
    FIELDINFO[4].setterMethod = "setStarttime";
    FIELDINFO[4].checkMethod = null;
    // Field 5
    FIELDINFO[5].defaultValue = null;
    FIELDINFO[5].fieldJavaName = "Elapsedtime";
    FIELDINFO[5].fieldLocalName = "elapsedtime";
    ...
    FIELDINFO[5].getterMethod = "getElapsedtime";
    FIELDINFO[5].setterMethod = "setElapsedtime";
    FIELDINFO[5].checkMethod = null;
    // Field 6
    FIELDINFO[6].defaultValue = null;
    FIELDINFO[6].fieldJavaName = "Pid";
    FIELDINFO[6].fieldLocalName = "pid";
    ...
    FIELDINFO[6].getterMethod = "getPid";
    FIELDINFO[6].setterMethod = "setPid";
