 ...
 */
public  class GetAlertTreeResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Tree";
    FIELDINFO[0].fieldLocalName = "tree";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfAlertNode";
    FIELDINFO[0].typeLocalName = "ArrayOfAlertNode";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getTree";
    FIELDINFO[0].setterMethod = "setTree";
