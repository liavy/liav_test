...
public  class ArrayOfInt implements java.io.Serializable {
   ...
   */
  public void setItem(java.lang.Integer[] _Item) {
    this._f_Item.clear();
    if (_Item != null) {
  ...
  public java.lang.Integer[] getItem() {
    java.lang.Integer[] result = new java.lang.Integer[_f_Item.size()];
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof ArrayOfInt)) return false;
    ArrayOfInt typed = (ArrayOfInt) object;
    java.lang.Integer[] _f_Item1 = this.getItem();
    java.lang.Integer[] _f_Item2 = typed.getItem();
    if (_f_Item1 != null) {
