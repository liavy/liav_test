 ...
 */
public  class InstanceVersionInfoSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[1].fieldJavaName = "VersionInfo";
    FIELDINFO[1].fieldLocalName = "VersionInfo";
    ...
    FIELDINFO[1].getterMethod = "getVersionInfo";
    FIELDINFO[1].setterMethod = "setVersionInfo";
    FIELDINFO[1].checkMethod = null;
    // Field 2
    FIELDINFO[2].defaultValue = null;
    FIELDINFO[2].fieldJavaName = "Time";
    FIELDINFO[2].fieldLocalName = "Time";
    ...
    FIELDINFO[2].getterMethod = "getTime";
    FIELDINFO[2].setterMethod = "setTime";
