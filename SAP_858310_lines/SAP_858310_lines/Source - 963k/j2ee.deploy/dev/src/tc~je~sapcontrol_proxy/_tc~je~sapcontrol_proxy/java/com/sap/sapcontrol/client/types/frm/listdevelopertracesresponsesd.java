 ...
 */
public  class ListDeveloperTracesResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "File";
    FIELDINFO[0].fieldLocalName = "file";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfDirEntry";
    FIELDINFO[0].typeLocalName = "ArrayOfDirEntry";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getFile";
    FIELDINFO[0].setterMethod = "setFile";
