 ...
 */
public  class TaskHandlerQueueSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Typ";
    FIELDINFO[0].fieldLocalName = "Typ";
    ...
    FIELDINFO[0].getterMethod = "getTyp";
    FIELDINFO[0].setterMethod = "setTyp";
    FIELDINFO[0].checkMethod = null;
    // Field 1
    FIELDINFO[1].defaultValue = null;
    FIELDINFO[1].fieldJavaName = "Now";
    FIELDINFO[1].fieldLocalName = "Now";
    ...
    FIELDINFO[1].getterMethod = "getNow";
    FIELDINFO[1].setterMethod = "setNow";
    FIELDINFO[1].checkMethod = null;
    // Field 2
    FIELDINFO[2].defaultValue = null;
    FIELDINFO[2].fieldJavaName = "High";
    FIELDINFO[2].fieldLocalName = "High";
    ...
    FIELDINFO[2].getterMethod = "getHigh";
    FIELDINFO[2].setterMethod = "setHigh";
    FIELDINFO[2].checkMethod = null;
    // Field 3
    FIELDINFO[3].defaultValue = null;
    FIELDINFO[3].fieldJavaName = "Max";
    FIELDINFO[3].fieldLocalName = "Max";
    ...
    FIELDINFO[3].getterMethod = "getMax";
    FIELDINFO[3].setterMethod = "setMax";
    FIELDINFO[3].checkMethod = null;
    // Field 4
    FIELDINFO[4].defaultValue = null;
    FIELDINFO[4].fieldJavaName = "Writes";
    FIELDINFO[4].fieldLocalName = "Writes";
    ...
    FIELDINFO[4].getterMethod = "getWrites";
    FIELDINFO[4].setterMethod = "setWrites";
    FIELDINFO[4].checkMethod = null;
    // Field 5
    FIELDINFO[5].defaultValue = null;
    FIELDINFO[5].fieldJavaName = "Reads";
    FIELDINFO[5].fieldLocalName = "Reads";
    ...
    FIELDINFO[5].getterMethod = "getReads";
    FIELDINFO[5].setterMethod = "setReads";
