 ...
 */
public  class J2EEGetVMHeapInfoResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Heap";
    FIELDINFO[0].fieldLocalName = "heap";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfHeapInfo";
    FIELDINFO[0].typeLocalName = "ArrayOfHeapInfo";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getHeap";
    FIELDINFO[0].setterMethod = "setHeap";
