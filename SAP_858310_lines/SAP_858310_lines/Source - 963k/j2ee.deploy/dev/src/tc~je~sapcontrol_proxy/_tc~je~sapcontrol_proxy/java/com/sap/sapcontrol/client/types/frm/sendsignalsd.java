 ...
 */
public  class SendSignalSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Pid";
    FIELDINFO[0].fieldLocalName = "pid";
    ...
    FIELDINFO[0].getterMethod = "getPid";
    FIELDINFO[0].setterMethod = "setPid";
    FIELDINFO[0].checkMethod = null;
    // Field 1
    FIELDINFO[1].defaultValue = null;
    FIELDINFO[1].fieldJavaName = "Signal";
    FIELDINFO[1].fieldLocalName = "signal";
    ...
    FIELDINFO[1].getterMethod = "getSignal";
    FIELDINFO[1].setterMethod = "setSignal";
