 ...
 */
public  class LogFileSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[1].fieldJavaName = "Size";
    FIELDINFO[1].fieldLocalName = "size";
    ...
    FIELDINFO[1].typeJavaName = "long";
    FIELDINFO[1].typeLocalName = "unsignedInt";
    FIELDINFO[1].typeUri = "http://www.w3.org/2001/XMLSchema";
    FIELDINFO[1].getterMethod = "getSize";
    FIELDINFO[1].setterMethod = "setSize";
    FIELDINFO[1].checkMethod = null;
    // Field 2
    FIELDINFO[2].defaultValue = null;
    FIELDINFO[2].fieldJavaName = "Modtime";
    FIELDINFO[2].fieldLocalName = "modtime";
    ...
    FIELDINFO[2].getterMethod = "getModtime";
    FIELDINFO[2].setterMethod = "setModtime";
    FIELDINFO[2].checkMethod = null;
    // Field 3
    FIELDINFO[3].defaultValue = null;
    FIELDINFO[3].fieldJavaName = "Format";
    FIELDINFO[3].fieldLocalName = "format";
    ...
    FIELDINFO[3].getterMethod = "getFormat";
    FIELDINFO[3].setterMethod = "setFormat";
