 ...
 */
public  class J2EEGetClusterMsgListResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Msg";
    FIELDINFO[0].fieldLocalName = "msg";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfJ2EEClusterMsg";
    FIELDINFO[0].typeLocalName = "ArrayOfJ2EEClusterMsg";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getMsg";
    FIELDINFO[0].setterMethod = "setMsg";
