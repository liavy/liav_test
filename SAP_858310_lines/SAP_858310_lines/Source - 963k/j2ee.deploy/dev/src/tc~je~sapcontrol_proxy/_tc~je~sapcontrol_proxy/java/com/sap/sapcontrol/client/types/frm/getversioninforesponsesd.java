 ...
 */
public  class GetVersionInfoResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Version";
    FIELDINFO[0].fieldLocalName = "version";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfInstanceVersionInfo";
    FIELDINFO[0].typeLocalName = "ArrayOfInstanceVersionInfo";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getVersion";
    FIELDINFO[0].setterMethod = "setVersion";
