 ...
 */
public  class GetAlertsResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "RootTidName";
    FIELDINFO[0].fieldLocalName = "RootTidName";
    ...
    FIELDINFO[0].getterMethod = "getRootTidName";
    FIELDINFO[0].setterMethod = "setRootTidName";
    FIELDINFO[0].checkMethod = null;
    // Field 1
    FIELDINFO[1].defaultValue = null;
    FIELDINFO[1].fieldJavaName = "Alert";
    FIELDINFO[1].fieldLocalName = "alert";
    ...
    FIELDINFO[1].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfAlert";
    FIELDINFO[1].typeLocalName = "ArrayOfAlert";
    FIELDINFO[1].typeUri = "urn:SAPControl";
    FIELDINFO[1].getterMethod = "getAlert";
    FIELDINFO[1].setterMethod = "setAlert";
