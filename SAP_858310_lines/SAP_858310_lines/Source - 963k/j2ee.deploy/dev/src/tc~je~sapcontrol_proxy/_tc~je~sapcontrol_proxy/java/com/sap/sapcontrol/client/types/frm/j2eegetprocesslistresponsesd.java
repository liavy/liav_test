 ...
 */
public  class J2EEGetProcessListResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Process";
    FIELDINFO[0].fieldLocalName = "process";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfJ2EEProcess";
    FIELDINFO[0].typeLocalName = "ArrayOfJ2EEProcess";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getProcess";
    FIELDINFO[0].setterMethod = "setProcess";
