 ...
 */
public  class J2EEApplicationAliasSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "AppName";
    FIELDINFO[0].fieldLocalName = "AppName";
    ...
    FIELDINFO[0].getterMethod = "getAppName";
    FIELDINFO[0].setterMethod = "setAppName";
    FIELDINFO[0].checkMethod = null;
    // Field 1
    FIELDINFO[1].defaultValue = null;
    FIELDINFO[1].fieldJavaName = "Alias";
    FIELDINFO[1].fieldLocalName = "Alias";
    ...
    FIELDINFO[1].getterMethod = "getAlias";
    FIELDINFO[1].setterMethod = "setAlias";
    FIELDINFO[1].checkMethod = null;
    // Field 2
    FIELDINFO[2].defaultValue = null;
    FIELDINFO[2].fieldJavaName = "TotalRequests";
    FIELDINFO[2].fieldLocalName = "TotalRequests";
    ...
    FIELDINFO[2].getterMethod = "getTotalRequests";
    FIELDINFO[2].setterMethod = "setTotalRequests";
    FIELDINFO[2].checkMethod = null;
    // Field 3
    FIELDINFO[3].defaultValue = null;
    FIELDINFO[3].fieldJavaName = "AppActive";
    FIELDINFO[3].fieldLocalName = "AppActive";
    ...
    FIELDINFO[3].getterMethod = "getAppActive";
    FIELDINFO[3].setterMethod = "setAppActive";
    FIELDINFO[3].checkMethod = null;
    // Field 4
    FIELDINFO[4].defaultValue = null;
    FIELDINFO[4].fieldJavaName = "IgnoreCookie";
    FIELDINFO[4].fieldLocalName = "IgnoreCookie";
    ...
    FIELDINFO[4].getterMethod = "getIgnoreCookie";
    FIELDINFO[4].setterMethod = "setIgnoreCookie";
