 ...
 */
public  class J2EEGetVMGCHistory2ResponseSD extends com.sap.engine.services.webservices.jaxrpc.encoding.GeneratedComplexType {
  ...
  private synchronized static void initFields() {
    ...
    FIELDINFO[0].fieldJavaName = "Gc";
    FIELDINFO[0].fieldLocalName = "gc";
    ...
    FIELDINFO[0].typeJavaName = "com.sap.sapcontrol.client.types.ArrayOfGCInfo2";
    FIELDINFO[0].typeLocalName = "ArrayOfGCInfo2";
    FIELDINFO[0].typeUri = "urn:SAPControl";
    FIELDINFO[0].getterMethod = "getGc";
    FIELDINFO[0].setterMethod = "setGc";
