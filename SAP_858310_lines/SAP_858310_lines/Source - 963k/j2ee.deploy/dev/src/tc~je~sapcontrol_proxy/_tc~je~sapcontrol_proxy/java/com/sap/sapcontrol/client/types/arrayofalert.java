 ...
 */
public  class ArrayOfAlert implements java.io.Serializable {
   ...
   */
  public void setItem(com.sap.sapcontrol.client.types.Alert[] _Item) {
    this._f_Item.clear();
    if (_Item != null) {
   ...
   */
  public com.sap.sapcontrol.client.types.Alert[] getItem() {
    com.sap.sapcontrol.client.types.Alert[] result = new com.sap.sapcontrol.client.types.Alert[_f_Item.size()];
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof ArrayOfAlert)) return false;
    ArrayOfAlert typed = (ArrayOfAlert) object;
    com.sap.sapcontrol.client.types.Alert[] _f_Item1 = this.getItem();
    com.sap.sapcontrol.client.types.Alert[] _f_Item2 = typed.getItem();
    if (_f_Item1 != null) {
